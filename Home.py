...
# Si el usuario SÍ está logueado, mostrar la app normal
    ...
    with col1:
        ...
        st.markdown("Calcule las prestaciones semestrales/anuales (Cesantías, Primas).")
    ...
    with col2:
        ...
        # --- ¡NUEVA LÍNEA AÑADIDA! ---
        st.markdown("#### 📊 Consolidado de Costos")
        st.markdown("Un resumen de todos los costos, deducciones y provisiones (Mensual y Especial).")
