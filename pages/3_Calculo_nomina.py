...
if st.button("Guardar Variables y Calcular Nómina Mensual", type="primary"):
    ...
    with st.spinner("Paso 2/3: Realizando cálculos mensuales..."):
        ...
        df_calculo['Total_Horas_Extra'] = df_calculo[['Val_Horas_extras_diurna', 'Val_Nocturna_ordinaria', 'Val_Extra_nocturna', 'Val_Dominical_festiva_ordinaria', 'Val_Extra_diurna_dominical_festiva', 'Val_Extra_nocturna_dominical/festiva']].sum(axis=1)
        ...
        # Se añade 'Días incapacidad' (que ahora es un valor en dinero)
        df_calculo['Total_Devengado'] = df_calculo['Salario del trabajador'] + \
                                       ...
                                       df_calculo['Días incapacidad'] # <-- ¡AÑADIDO!
    ...
    with st.spinner("Paso 3/3: Guardando resultados en Google Sheets..."):
        ...
        # Corregir el KeyError que vimos antes
