...
# --- MODIFICADO: Añadido 'Bono rendimiento' ---
columnas_liq_completas = [
    'Cédula', 'Nombre completo', 'Salario del trabajador', 'Aux Transporte', 'Bono rendimiento', # <-- NUEVA COLUMNA
    'Días trabajados', 'Días incapacidad', 
...
# --- MODIFICADO: Añadido 'Bono rendimiento' ---
columnas_a_limpiar = [
    'Bono rendimiento', # <-- NUEVA COLUMNA
...
st.info("Ingrese el salario, bonos, días, horas extra, vacaciones y descuentos (Préstamos, ReteFuente, etc.) para el período actual.")

# --- Botón de Limpieza ---
if st.button("Limpiar Variables del Mes (Poner en Cero)", help="Pone en 0 todas las columnas desde 'Bono rendimiento' en adelante."):
...
if st.button("Guardar Variables y Calcular Nómina Mensual", type="primary"):
    ...
    with st.spinner("Paso 2/3: Realizando cálculos mensuales..."):
        ...
        # --- MODIFICADO: Añadido 'Bono rendimiento' ---
        cols_numericas = [
            'Salario del trabajador', 'Aux Transporte', 'Bono rendimiento', # <-- NUEVA COLUMNA
            'Días trabajados', 'Días incapacidad', 
            'Horas extras diurna', 'Nocturna ordinaria', 'Extra nocturna', 'Dominical/festiva ordinaria', 
            'Extra diurna dominical/festiva', 'Extra nocturna dominical/festiva', 'Días vacaciones',
            'Prestamos', 'Otros Descuentos', 'Retención en la Fuente'
        ...
        # --- LÓGICA DE CARGA DE INDICADORES ---
        ...
        # 5. Total Devengado (¡MODIFICADO!)
        # Se añade 'Bono rendimiento'
        df_calculo['Total_Devengado'] = df_calculo['Salario del trabajador'] + \
                                       ...
                                       df_calculo['Días incapacidad'] + \
                                       df_calculo['Bono rendimiento'] # <-- ¡AÑADIDO!
    ...
    with st.spinner("Paso 3/3: Guardando resultados en Google Sheets..."):
        ...
        cols_liquidacion = [
            'Cédula', 'Nombre completo', 'Salario del trabajador', 'Aux Transporte', 'Bono rendimiento', # <-- NUEVA COLUMNA
            'Días incapacidad', 'Val_Horas_extras_diurna', 'Val_Nocturna_ordinaria', 'Val_Extra_nocturna', 
            'Val_Dominical_festiva_ordinaria', 'Val_Extra_diurna_dominical_festiva', 
            'Val_Extra_nocturna_dominical_festiva', 'Val_Vacaciones', 'Total_Devengado'
        ]
